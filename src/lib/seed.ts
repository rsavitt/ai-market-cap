...
const entities: EntitySeed[] = [
  ...
  { id:"gpt4o-coding", name:"GPT-4o (Coding)", category:"coding", company:"OpenAI", release_date:"2024-05-13", pricing_tier:"freemium", availability:"API,Web", open_source:0, description:"GPT-4o optimized for code generation and review", base_usage:85, base_attention:72, base_capability:85, base_expert:80, trend:-0.15, noise:1.2 },
