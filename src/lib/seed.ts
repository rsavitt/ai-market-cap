...
const entities: EntitySeed[] = [
  ...
  { id:"hermes-agent", name:"Hermes Agent", category:"agent_tools", company:"Nous Research", release_date:"2025-06-01", pricing_tier:"free", availability:"CLI", open_source:1, description:"Fully open-source AI agent with persistent memory and multi-platform messaging", base_usage:45, base_attention:62, base_capability:78, base_expert:74, trend:0.4, noise:2.5 },
  ...
  { id:"crewai", name:"CrewAI", category:"agent_tools", company:"CrewAI", release_date:"2024-01-15", pricing_tier:"freemium", availability:"API,CLI", open_source:1, description:"Framework for orchestrating multi-agent AI systems", base_usage:58, base_attention:65, base_capability:75, base_expert:72, trend:0.3, noise:2.0 },
  { id:"langchain-agents", name:"LangChain Agents", category:"agent_tools", company:"LangChain", release_date:"2023-10-01", pricing_tier:"free", availability:"API", open_source:1, description:"Agent framework within the LangChain ecosystem", base_usage:68, base_attention:55, base_capability:74, base_expert:76, trend:0.1, noise:1.5 },
  ...
  { id:"browseruse", name:"Browser Use", category:"agent_tools", company:"Browser Use", release_date:"2024-11-01", pricing_tier:"free", availability:"API,CLI", open_source:1, description:"AI agent framework for autonomous web browser interaction", base_usage:40, base_attention:70, base_capability:72, base_expert:65, trend:0.6, noise:3.0 },
